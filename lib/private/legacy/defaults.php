...
class OC_Defaults {
	...
	public function __construct() {
		...
		$this->defaultEntity = 'JTI-PRODI'; /* e.g. company name, used for footers and copyright notices */
		$this->defaultName = 'JTI-PRODI'; /* short name, used when referring to the software */
		$this->defaultTitle = 'JTI-PRODI'; /* can be a longer name, for titles */
		...
		$this->defaultSlogan = $this->l->t('Data Arsip Program Studi JTI');
